 ...
 */
module.exports = class MetricFile extends Transports.File {
  /**
  ...
  constructor (options = {}) {
    ...
    this._histTimerLog = !!Metrics.isInitiated() && Metrics.getHistogram(
      'central_services_logger_transport_file',
      'Central Services Logger - Performance Metric for File Transport',
      ['success', 'level']
    )
  }
  ...
  log (info, callback = () => {}) {
    ...
    const result = Transports.File.prototype.log.call(this, info, callback)
